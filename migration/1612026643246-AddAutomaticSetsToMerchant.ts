...
export class AddAutomaticSetsToMerchant1612026643246 implements MigrationInterface {
    name = 'AddAutomaticSetsToMerchant1612026643246'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "merchant" ADD "automaticSets" boolean NOT NULL DEFAULT false`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`COMMENT ON COLUMN "customization_options"."title" IS NULL`);
        await queryRunner.query(`ALTER TABLE "merchant" DROP COLUMN "automaticSets"`);
    }
